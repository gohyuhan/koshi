...
fn worker_stops_before_unique_templates_exceed_the_frame_bound() {
    ...
    let output_paints = (0u8..8)
        .map(|image_variant_index| {
            ...
            output_paint.placement_key = (pane, u64::from(image_variant_index) + 1);
