...
//! ends one of two ways — its child `Exited` (carrying the exit code and when),
//! or a requested `Closing` (carrying since-when) — before it is finally
