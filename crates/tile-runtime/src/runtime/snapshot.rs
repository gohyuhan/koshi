...
//! [`Arc<Grid>`](tile_terminal::grid::state::Grid) handle from
//! [`TerminalState::active_grid_arc`](tile_terminal::state::TerminalState::active_grid_arc),
...
use tile_core::ids::{ClientId, PaneId};
use tile_layout::content::content_rects;
use tile_layout::solver::{solve_with_mode, SolveResult};
use tile_pane::pane::lifecycle::PaneLifecycle;
use tile_pane::pane::state::PaneKind;
use tile_renderer::snapshot::{
