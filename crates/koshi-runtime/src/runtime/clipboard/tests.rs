...
#[test]
fn osc52_uses_the_shared_clipboard_writer() {
...
#[cfg(feature = "native")]
#[test]
fn arboard_uses_the_shared_clipboard_writer() {
    fn accepts_writer<T: ClipboardWriter>() {}

    accepts_writer::<ArboardClipboard>();
}
