...
|---|---|---|
| `koshi.kdl` | Theme, image, reduced-motion, pane placement, pane, scrollback, layout, mouse, copy, terminal, logging, update, beta-feature, session-closing, other-user access, and remote access settings | [koshi.md](koshi.md) |
...
| `profile/<name>.kdl` | A saved layout: tabs, panes, commands, and the starting input mode, opened with `koshi --profile <name>` | [profile.md](profile.md) |
